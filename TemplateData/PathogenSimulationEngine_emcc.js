...
var wasmBinaryFile = "PathogenSimulationEngine_emcc.wasm";
...
function CreateEngineJS() {
 let global = Function("return this")();
 global.simulationEngine = new global.Module.SimEngine();
 global.simulationEngine.RegisterSelfAsGlobalSimEngine();
}

function FileReadToStringESJS(str) {
 if (!ENVIRONMENT_IS_SHELL) {
  let inFileName = UTF8ToString(str);
  let jsString = read_(inFileName);
  ...
  let inFileName = UTF8ToString(str);
  let binArray = readBinary(inFileName);
  let jsString = String.fromCharCode(...binArray);
  var lengthBytes = lengthBytesUTF8(jsString) + 1;
  var stringOnWasmHeap = _malloc(lengthBytes);
  stringToUTF8(jsString, stringOnWasmHeap, lengthBytes);
  return stringOnWasmHeap;
...
var asmLibraryArg = {
 ...
 "A": __embind_register_class_constructor,
 ...
 "X": _emscripten_run_script,
 "G": _emscripten_run_script_int,
 "a": _getTempRet0,
 "W": invoke_dii,
 "V": invoke_fi,
 "U": invoke_fiff,
...
var ___getTypeName = Module["___getTypeName"] = function() {
 return (___getTypeName = Module["___getTypeName"] = Module["asm"]["ja"]).apply(null, arguments);
};

var ___embind_register_native_and_builtin_types = Module["___embind_register_native_and_builtin_types"] = function() {
 return (___embind_register_native_and_builtin_types = Module["___embind_register_native_and_builtin_types"] = Module["asm"]["ka"]).apply(null, arguments);
};
...
var ___cxa_can_catch = Module["___cxa_can_catch"] = function() {
 return (___cxa_can_catch = Module["___cxa_can_catch"] = Module["asm"]["pa"]).apply(null, arguments);
};
...
var dynCall_iij = Module["dynCall_iij"] = function() {
 return (dynCall_iij = Module["dynCall_iij"] = Module["asm"]["ra"]).apply(null, arguments);
};
